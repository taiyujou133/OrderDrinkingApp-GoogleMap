//
//  HotDrinkingTableViewController.swift
//  OrderDrinkingApp
//
...
class HotDrinkingTableViewController: UITableViewController {
                ...
                if let data {
                    ...
                    do {
                        ...
                        for i in 0...(menuDataList.records.count - 1){
                            if menuDataList.records[i].fields.iceHotKind[0] == "Hot" {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "\(HotDrinkingTableViewCell.self)", for: indexPath) as! HotDrinkingTableViewCell
